...
2. View it with an image-rendering tool
...
For a focused command reference covering the most useful `rdc-cli` workflows in this repo, see [references/commands-quick-ref.md](references/commands-quick-ref.md).

For extended debugging recipes and investigation checklists, see [references/debugging-recipes.md](references/debugging-recipes.md).
